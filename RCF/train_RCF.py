...
parser.add_argument('--batch_size', default=1, type=int, metavar='BT',
                    help='batch size')
# =============== optimizer
parser.add_argument('--lr', '--learning_rate', default=1e-9, type=float,
...
parser.add_argument('--maxepoch', default=7, type=int, metavar='N',
                    help='number of total epochs to run')
parser.add_argument('--itersize', default=10, type=int, #10
                    metavar='IS', help='iter size')
# =============== misc
parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                    help='manual epoch number (useful on restarts)')
parser.add_argument('--print_freq', '-p', default=10, type=int, #1000
                    metavar='N', help='print frequency (default: 50)')
parser.add_argument('--gpu', default='1', type=str,
                    help='GPU ID')
parser.add_argument('--resume', default='./pretrained/RCFcheckpoint_epoch12.pth', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
parser.add_argument('--tmp', help='tmp folder', default='tmp/RCFtune_test')
# ================ dataset
...
THIS_DIR = abspath(dirname(__file__)) # '/nfs1/home/kevin7770726/PycharmProjects/RepeatPatternCounting/src/RCF'
TMP_DIR = join(THIS_DIR, args.tmp) # '/nfs1/home/kevin7770726/PycharmProjects/RepeatPatternCounting/src/RCF/tmp/RCF'
...
def main():
    ...
    tune_dataset = BSDS_RCFLoader(root=args.dataset, split='train') # train/tune
    train_loader = DataLoader(
        tune_dataset, batch_size=args.batch_size,
